...
function updateHeader(language: 'ar' | 'en'): void {
...
function displayLayers(layers: OSILayer[], containerID: string, language: 'ar' | 'en', svgIcon: 'senderIcon' | 'receiverIcon'): void {
...
function handleLanguageChange(language: 'ar' | 'en'): void {
  ...
  const arabicButton = document.getElementById('arabic')! as HTMLButtonElement;
  const englishButton = document.getElementById('english')! as HTMLButtonElement;
